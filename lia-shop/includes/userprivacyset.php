<?php
function lia_user_privacy_func( $atts ) {
    $lia_user_privacy = '<div class="user_prof_container">                        
                       ...
                       <div class="user_prof_form">
                         User privacy setting page
                       </div>
                   </div>';
	return  $lia_user_privacy;
}
add_shortcode( 'user_privacy', 'lia_user_privacy_func' );